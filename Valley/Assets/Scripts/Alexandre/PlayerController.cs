...
public class PlayerController : MonoBehaviour
{
    ...
    private void Update()
    {
        if (Input.GetKeyDown(KeyCode.Alpha1) || Input.GetButtonDown("A Button")) 
        {
        ...
        if (Input.GetKeyDown(KeyCode.Alpha2) || Input.GetButtonDown("X Button")) {SandBoxManager.instance.PutBalise(transform.position + body.forward); }

        if (Input.GetKeyDown(KeyCode.Alpha3) ||Input.GetButtonDown("Y Button")) { PinManager.instance.OpenMap(); }
    }
