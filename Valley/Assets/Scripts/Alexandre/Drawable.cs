...
namespace FreeDraw
{
    ...
    public class Drawable : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            Vector2 mouse_world_position = wantedCam.ScreenToWorldPoint(new Vector2(PlayerManager.instance.playerBody.transform.position.x+280f, PlayerManager.instance.playerBody.transform.position.z+185f) * 1f + new Vector2(170, 150));
